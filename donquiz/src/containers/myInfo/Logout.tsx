          ...
          {userData?.fetchedQuizList.length ? (
            userData?.fetchedQuizList.map((quizData, index) => {
              return (
                ...
                >
                  <div className="duration-300 hover:scale-105 flex flex-col items-center justify-center border-4 border-black w-full min-h-[250px] rounded-2xl overflow-hidden">
